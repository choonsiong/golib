...
func TestSlope(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got != tt.want {
				t.Errorf("(%v).Slope(%v) == %v; want %v", tt.coordinateA, tt.coordinateB, got, tt.want)
			}
		})
	}
}
...
func TestMidpoint(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.midpointX != gotX {
				t.Errorf("(%v).Midpoint(%v) == %v; want midpoint x %v", tt.coordinateA, tt.coordinateB, gotX, tt.midpointX)
			}

			if tt.midpointY != gotY {
				t.Errorf("(%v).Midpoint(%v) == %v; want midpoint y %v", tt.coordinateA, tt.coordinateB, gotY, tt.midpointY)
			}
		})
	}
}
...
func TestMidpoint3D(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantX != gotX {
				t.Errorf("(%v).Midpoint(%v) == %v; want %v", tt.coordinateA, tt.coordinateB, gotX, tt.wantX)
			}
			if tt.wantY != gotY {
				t.Errorf("(%v).Midpoint(%v) == %v; want %v", tt.coordinateA, tt.coordinateB, gotY, tt.wantY)
			}
			if tt.wantZ != gotZ {
				t.Errorf("(%v).Midpoint(%v) == %v; want %v", tt.coordinateA, tt.coordinateB, gotZ, tt.wantZ)
			}
		})
	}
}
...
func TestEndPoint3D(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.wantX != gotX {
				t.Errorf("(%v).EndPointB(%v) == %v; want %v", tt.coordinateA, tt.midpoint, gotX, tt.wantX)
			}
			if tt.wantY != gotY {
				t.Errorf("(%v).EndPointB(%v) == %v; want %v", tt.coordinateA, tt.midpoint, gotY, tt.wantY)
			}
			if tt.wantZ != gotZ {
				t.Errorf("(%v).EndPointB(%v) == %v; want %v", tt.coordinateA, tt.midpoint, gotZ, tt.wantZ)
			}
		})
	}
}
